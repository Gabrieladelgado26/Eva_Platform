...
$(document).ready(function(){ 
    ...
    $(".sonido_click").click(function() { 
     ...
     $(".iconocerrar").click(function() {
        ...
        //setTimeout(function(){reproducionSonido('OVAs/Ciencias-Sociales/Patrimonio-Cultural/sounds/system/background_music.mp3',1)},600); 
        if($("#btnpausaplay").attr("title")=='Silenciar') setTimeout(function(){reproducionSonido('OVAs/Ciencias-Sociales/Patrimonio-Cultural/sounds/system/background_music.mp3',1)},600); 
      });
...
function pausaplay(opcion)
{
  ...
  }else if(opcion==1)
  {
    ...
    reproducionSonido('OVAs/Ciencias-Sociales/Patrimonio-Cultural/sounds/system/background_music.mp3',1);
  }
}
