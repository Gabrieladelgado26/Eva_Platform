...
function inicioJuego()
{
  ...
  setTimeout(function(){reproducionSonido('sonidos/enunciado.mp3')},4500);
...
$(document).ready(function(){ 
   ...
   $("#numeros").append('<img id="3" class="numeros" src="img/tres.png" style="display:none">'+
                      '<img id="2" class="numeros" src="img/dos.png" style="display:none">'+
                      '<img id="1" class="numeros" src="img/uno.png" style="display:none">'+
                      '<img id="juega" class="juega" src="img/juega.png" style="display:none">');
