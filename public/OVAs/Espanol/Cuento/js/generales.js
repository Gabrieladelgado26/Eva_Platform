...
$(document).ready(function(){ 
    ...
    $(".iconocerrar").click(function() {
        ...
        //setTimeout(function(){reproducionSonido('OVAs/Espanol/Cuento/sounds/system/start.mp3',1)},600); 
        if($("#btnpausaplay").attr("title")=='Silenciar') setTimeout(function(){reproducionSonido('OVAs/Espanol/Cuento/sounds/system/background_music.mp3',1)},600); 
      });
...
function pausaplay(opcion)
{
  ...
  }else if(opcion==1)
  {
    ...
    reproducionSonido('OVAs/Espanol/Cuento/sounds/system/background_music.mp3',1);
  }
}
