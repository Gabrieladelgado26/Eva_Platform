...
<head>
    ...
    <title>Cuenta desactivada - EVA Platform</title>
</head>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    ...
                                    <td align="right" style="vertical-align: middle;">
                                        <span style="color: #c0392b; font-size: 13px; font-weight: 500; padding: 4px 10px; background-color: #fbe9e7; border-radius: 20px;">INACTIVA</span>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td style="padding: 32px 48px;">
                            ...
                            <p style="margin: 0 0 16px; color: #34495e; font-size: 15px; line-height: 1.6;">
                                Le informamos que su cuenta ha sido <strong style="color: #c0392b;">desactivada</strong> en la plataforma EVA. En este momento, no podrá acceder al sistema.
                            </p>
                                ...
                                <tr>
                                    <td style="padding: 20px;">
                                        ...
                                        <p style="margin: 6px 0; color: #34495e; font-size: 14px;">
                                            ...
                                            <span style="color: #c0392b;">Inactiva</span>
                                        </p>
                            ...
                            <p style="margin: 0 0 8px; color: #7f8c8d; font-size: 13px; line-height: 1.5;">
                                Si considera que esto es un error o necesita más información, contacte al administrador del sistema.
                            </p>
