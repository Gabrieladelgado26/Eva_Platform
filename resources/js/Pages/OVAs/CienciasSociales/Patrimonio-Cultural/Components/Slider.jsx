// ─────────────────────────────────────────────────────────────────────────────
// Components/Slider.jsx  —  OVA Ciencias Sociales › Patrimonio Cultural
// Tutorial slider — renderizado en iframe desde slider.blade.php
// ─────────────────────────────────────────────────────────────────────────────
        ...
        <div className="flex-container">
            <div className="flexslider">
                <ul className="slides">
                    ...
                    <li>
                        <a href="#">
                            <img src={`${BASE}/images/slider/slide_modal_conoce.png`} alt="Conoce el OVA" />
                            <img src={`${BASE}/images/modals/modal_audio.png`}
                                className="sonidoslider repro_audio1" alt="" draggable={false} />
                            <audio id="audio1" src={`${SHARED}/sounds/tutorial/tutorial_conoce.mp3`} />
                        </a>
                    </li>
                    ...
                    <li>
                        ...
                        <img src={`${BASE}/images/slider/slide_modal_aprende_mas.png`} alt="Aprende más" />
                        <audio id="audio2" src={`${SHARED}/sounds/tutorial/tutorial_aprende_mas.mp3`} />
                    </li>

                    <li>
                        <img src={`${BASE}/images/modals/modal_audio.png`}
                            className="sonidoslider repro_audio3" alt="" draggable={false} />
                        <img src={`${BASE}/images/slider/slide_modal_repasemos.png`} alt="Repasemos" />
                        <audio id="audio3" src={`${SHARED}/sounds/tutorial/tutorial_repasemos.mp3`} />
                    </li>

                    <li>
                        <img src={`${BASE}/images/modals/modal_audio.png`}
                            className="sonidoslider repro_audio4" alt="" draggable={false} />
                        <img src={`${BASE}/images/slider/slide_modal_evaluemos.png`} alt="Evaluemos" />
                        <audio id="audio4" src={`${SHARED}/sounds/tutorial/tutorial_evaluemos.mp3`} />
                    </li>
