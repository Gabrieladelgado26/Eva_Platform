// ─────────────────────────────────────────────────────────────────────────────
// Gastronomia.jsx  —  OVA Ciencias Sociales › Patrimonio Cultural
// Equivale a: gastronomia.php
// ─────────────────────────────────────────────────────────────────────────────
...
const REPASEMOS_SRC  = `${BASE}/repasemos/repasemosgastronomia/repasemosgastronomia.html`;
const CONOCE_VIDEO   = 'https://www.youtube-nocookie.com/embed/NiUXBKFqu50?rel=0&showinfo=0';
const APRENDE_SRC    = `${BASE}/juegos/gastronomia/menu.html`;
const EVALUEMOS_SRC  = `${BASE}/evaluemos/evaluemosgastronomia/evaluemosgastronomia.html`;

const IMG = {
    modalBg:     `${BASE}/images/modals/modal_bg.png`,
    modalReturn: `${BASE}/images/modals/modal_prev.png`,
    signTema:    `${BASE}/images/signboard/sign_gastronomia.png`,
};
    ...
    return (
        ...
        >
            <iframe id="contentframe" src={src} className="frame1" allowtransparency="true"
                style={{ border: 'none', background: 'transparent' }} title="Aprende más – Gastronomía" />
        </OvaModal>
    );
}
...
export default function Gastronomia() {
    return (
        <>
            <Head title="Investic – Gastronomía" />
            <OvaLayout
                metaTitle="Investic – Gastronomía"
                letrero={<img className="titulocontenido" src={IMG.signTema} alt="Gastronomía" draggable={false} />}
