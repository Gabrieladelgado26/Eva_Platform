// ─────────────────────────────────────────────────────────────────────────────
// Turismo.jsx  —  OVA Ciencias Sociales › Patrimonio Cultural
// Equivale a: turismo.php
// ─────────────────────────────────────────────────────────────────────────────
...
const REPASEMOS_SRC  = `${BASE}/repasemos/repasemosturismo/repasemosturismo.html`;
const CONOCE_VIDEO   = 'https://www.youtube-nocookie.com/embed/nvWaDR9L0Nw?rel=0&showinfo=0';
const APRENDE_SRC    = `${BASE}/juegos/turismo/menu.html`;
const EVALUEMOS_SRC  = `${BASE}/evaluemos/evaluemosturismo/evaluemosturismo.html`;

const IMG = {
    modalBg:     `${BASE}/images/modals/modal_bg.png`,
    modalReturn: `${BASE}/images/modals/modal_prev.png`,
    signTema:    `${BASE}/images/signboard/sign_turismo.png`,
};
    ...
    return (
        ...
        >
            <iframe id="contentframe" src={src} className="frame1" allowtransparency="true"
                style={{ border: 'none', background: 'transparent' }} title="Aprende más – Turismo" />
        </OvaModal>
    );
}
...
export default function Turismo() {
    return (
        <>
            <Head title="Investic – Turismo" />
            <OvaLayout
                metaTitle="Investic – Turismo"
                letrero={<img className="titulocontenido" src={IMG.signTema} alt="Turismo" draggable={false} />}
