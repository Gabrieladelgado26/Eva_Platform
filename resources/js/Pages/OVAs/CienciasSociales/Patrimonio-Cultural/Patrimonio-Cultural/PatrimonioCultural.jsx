// ─────────────────────────────────────────────────────────────────────────────
// PatrimonioCultural.jsx  —  OVA Ciencias Sociales › Patrimonio Cultural
// Equivale a: patrimoniocultural.php
// ─────────────────────────────────────────────────────────────────────────────
...
const REPASEMOS_SRC  = `${BASE}/repasemos/repasemospatrimonio/repasemospatrimonio.html`;
const CONOCE_VIDEO   = 'https://www.youtube-nocookie.com/embed/roFY-AuUxfc?rel=0&showinfo=0';
const APRENDE_SRC    = `${BASE}/juegos/patrimonio/menu.html`;
const EVALUEMOS_SRC  = `${BASE}/evaluemos/evaluemospatrimonio/evaluemospatrimonio.html`;

const IMG = {
    modalBg:     `${BASE}/images/modals/modal_bg.png`,
    modalReturn: `${BASE}/images/modals/modal_prev.png`,
    signTema:    `${BASE}/images/signboard/sign_patrimonio.png`,
};
    ...
    return (
        ...
        >
            <iframe id="contentframe" src={src} className="frame1" allowtransparency="true"
                style={{ border: 'none', background: 'transparent' }} title="Aprende más – Patrimonio Cultural" />
        </OvaModal>
    );
}
    ...
    return (
        ...
        >
            <iframe id="contentframeevaluemos" src={src} allowtransparency="true"
                ...
                title="Evaluemos – Patrimonio Cultural" />
        </OvaModal>
    );
}
...
export default function PatrimonioCultural() {
    return (
        <>
            ...
            <OvaLayout
                metaTitle="Investic – Patrimonio Cultural"
                letrero={<img className="titulocontenido" src={IMG.signTema} alt="Patrimonio Cultural" draggable={false} />}
