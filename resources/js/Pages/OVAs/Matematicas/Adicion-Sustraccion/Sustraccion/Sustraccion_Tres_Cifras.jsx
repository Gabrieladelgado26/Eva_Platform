...
const IMG = {
  letrero:     `${BASE}/images/signboard/sign_subtraction_3_digits.png`,
...
const REPASEMOS_SRC = `${BASE}/repasemos/sustracciondenumerosdetrescifras/sustracciondenumerosdetrescifras.html`;
const CONOCE_VIDEO  = "https://www.youtube-nocookie.com/embed/Gquq6H_TSlw?rel=0&amp;showinfo=0";
const APRENDE_SRC   = `${BASE}/juegos/sustracciondenumerosdetrescifras/menu.html`;
const EVALUEMOS_SRC = `${BASE}/evaluemos/sustracciondenumerosdetrescifras/sustracciondenumerosdetrescifras.html`;
  ...
  return (
    ...
    >
      <iframe
        ...
        title="Aprende más — Sustracción de números de tres cifras"
      />
    </OvaModal>
  );
}
  ...
  return (
    ...
    >
      <iframe
        ...
        allowtransparency="true"
        style={{ border: "none", background: "transparent" }}
        title="Evaluemos — Sustracción de números de tres cifras"
      />
    </OvaModal>
  );
}
...
// ─────────────────────────────────────────────────────────────────────────────
export default function SustraccionTresCifras() {
  return (
    <OvaLayout
      metaTitle="Sustracción de números de tres cifras"
      metaDescription="Sustracción de números de tres cifras"
      guiaTema="OVAs/Matematicas/Adicion-Sustraccion/guias/sustracciontrescifras.pdf"
      ...
      letrero={
        <img
          ...
          src={IMG.letrero}
          alt="Sustracción de números de tres cifras"
          draggable={false}
        />
      }
