...
const IMG = {
  letrero:     `${BASE}/images/signboard/sign_subtraction_up_to_19.png`,
...
const REPASEMOS_SRC = `${BASE}/repasemos/sustracciondenumeroshastael19/sustracciondenumeroshastael19.html`;
const CONOCE_VIDEO  = "https://www.youtube-nocookie.com/embed/WcbADgyT9Ts?rel=0&amp;showinfo=0";
const APRENDE_SRC   = `${BASE}/juegos/sustracciondenumeroshastael19/menu.html`;
const EVALUEMOS_SRC = `${BASE}/evaluemos/sustracciondenumeroshasta19/sustracciondenumeroshasta19.html`;
  ...
  return (
    ...
    >
      <iframe
        ...
        title="Aprende más — Sustracción de números hasta el 19"
      />
    </OvaModal>
  );
}
...
// ─────────────────────────────────────────────────────────────────────────────
export default function SustraccionHasta19() {
  return (
    <OvaLayout
      metaTitle="Sustracción de números hasta el 19"
      metaDescription="Sustracción de números hasta el 19"
      guiaTema="OVAs/Matematicas/Adicion-Sustraccion/guias/sustraccionnumeros19.pdf"
      ...
      letrero={
        <img
          ...
          src={IMG.letrero}
          alt="Sustracción de números hasta el 19"
          draggable={false}
        />
      }
