...
const IMG = {
  letrero:     `${BASE}/images/signboard/sign_addition_3_digits.png`,
...
const REPASEMOS_SRC = `${BASE}/repasemos/adiciondenumerosdetrescifras/adiciondenumerosdetrescifras.html`;
const CONOCE_VIDEO  = "https://www.youtube-nocookie.com/embed/dGQ8nQyBZWQ?rel=0&amp;showinfo=0";
const APRENDE_SRC   = `${BASE}/juegos/adiciondenumerosdetrescifras/menu.html`;
const EVALUEMOS_SRC = `${BASE}/evaluemos/adiciondenumerosdetrescifras/adiciondenumerosdetrescifras.html`;
  ...
  return (
    ...
    >
      <iframe
        ...
        title="Aprende más — Adición de números de tres cifras"
      />
    </OvaModal>
  );
}
  ...
  return (
    ...
    >
      <iframe
        ...
        allowtransparency="true"
        style={{ border: "none", background: "transparent" }}
        title="Evaluemos — Adición de números de tres cifras"
      />
    </OvaModal>
  );
}
...
// ─────────────────────────────────────────────────────────────────────────────
export default function AdicionTresCifras() {
  return (
    <OvaLayout
      metaTitle="Adición de números de tres cifras"
      metaDescription="Adición de números de tres cifras"
      guiaTema="OVAs/Matematicas/Adicion-Sustraccion/guias/adiciontrescifras.pdf"
      ...
      letrero={
        <img
          ...
          src={IMG.letrero}
          alt="Adición de números de tres cifras"
          draggable={false}
        />
      }
