// ─────────────────────────────────────────────────────────────────────────────
// Adaptaciones.jsx  —  OVA Ciencias Naturales › Seres Vivos
// ─────────────────────────────────────────────────────────────────────────────
...
const REPASEMOS_SRC  = `${BASE}/repasemos/repasemosadaptaciones/repasemosadaptaciones.html`;
const CONOCE_VIDEO   = 'https://www.youtube-nocookie.com/embed/HA28VPBLFsQ?rel=0&showinfo=0';
const APRENDE_SRC    = `${BASE}/juegos/adaptaciones/menu.html`;
const EVALUEMOS_SRC  = `${BASE}/evaluemos/evaluemosadaptaciones/evaluemosadaptaciones.html`;

const IMG = {
    modalBg:     `${BASE}/images/modals/modal_bg.png`,
    modalReturn: `${BASE}/images/modals/modal_prev.png`,
    signTema:    `${BASE}/images/signboard/sign_adaptaciones.png`,
};
    ...
    return (
        ...
        >
            <iframe id="contentframe" src={src} className="frame1" allowtransparency="true"
                style={{ border: 'none', background: 'transparent' }} title="Aprende más – Adaptaciones" />
        </OvaModal>
    );
}
    ...
    return (
        ...
        >
            <iframe id="contentframeevaluemos" src={src} allowtransparency="true"
                style={{ width: '100%', height: '93%', border: 'none', background: 'transparent' }} title="Evaluemos – Adaptaciones" />
        </OvaModal>
    );
}

export default function Adaptaciones() {
    return (
        <>
            <Head title="Investic – Adaptaciones" />
            <OvaLayout
                metaTitle="Investic – Adaptaciones"
                letrero={<img className="titulocontenido" src={IMG.signTema} alt="Adaptaciones" draggable={false} />}
