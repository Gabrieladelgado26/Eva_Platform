// ─────────────────────────────────────────────────────────────────────────────
// CicloDeVida.jsx  —  OVA Ciencias Naturales › Seres Vivos
// ─────────────────────────────────────────────────────────────────────────────
...
const REPASEMOS_SRC  = `${BASE}/repasemos/repasemosciclodevida/repasemosciclodevida.html`;
const CONOCE_VIDEO   = 'https://www.youtube-nocookie.com/embed/lPCgYQERJEY?rel=0&showinfo=0';
const APRENDE_SRC    = `${BASE}/juegos/ciclodevida/menu.html`;
const EVALUEMOS_SRC  = `${BASE}/evaluemos/evaluemosciclodevida/evaluemosciclodevida.html`;

const IMG = {
    modalBg:     `${BASE}/images/modals/modal_bg.png`,
    modalReturn: `${BASE}/images/modals/modal_prev.png`,
    signTema:    `${BASE}/images/signboard/sign_ciclo_vida.png`,
};
    ...
    return (
        ...
        >
            <iframe id="contentframe" src={src} className="frame1" allowtransparency="true"
                style={{ border: 'none', background: 'transparent' }} title="Aprende más – Ciclo de Vida" />
        </OvaModal>
    );
}
    ...
    return (
        ...
        >
            <iframe id="contentframeevaluemos" src={src} allowtransparency="true"
                style={{ width: '100%', height: '93%', border: 'none', background: 'transparent' }} title="Evaluemos – Ciclo de Vida" />
        </OvaModal>
    );
}
...
export default function CicloDeVida() {
    return (
        <>
            <Head title="Investic – Ciclo de Vida" />
            <OvaLayout
                metaTitle="Investic – Ciclo de Vida"
                letrero={<img className="titulocontenido" src={IMG.signTema} alt="Ciclo de Vida" draggable={false} />}
