// ─────────────────────────────────────────────────────────────────────────────
// Index.jsx  —  OVA Ciencias Naturales › Seres Vivos
...
//     → aparece al terminar el video (o tras 75 s, igual que el original)
...
const OVAIndex = () => {
    ...
    useEffect(() => {
        ...
        // Timeout original: 75 segundos
        const timeout = setTimeout(showMenuButton, 75000);
    ...
    const goToMenu = (e) => {
        e?.preventDefault();
        router.visit('/ovas/ciencias-naturales/seres-vivos/menu');
    };
        ...
        <>
            ...
            <div className="Skin2">
                ...
                <a href="#"
                   ...
                   onMouseEnter={() => {
                       setSkipHover(true);
                       new Audio(`${SHARED}/sounds/intro/intro_skip.mp3`).play().catch(() => {});
                   }}
                ...
                <a href="#"
                   ...
                   onMouseEnter={() => {
                       setMenuHover(true);
                       new Audio(`${SHARED}/sounds/navigation/nav_go_menu.mp3`).play().catch(() => {});
                   }}
