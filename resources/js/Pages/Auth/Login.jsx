    ...
    return (
        <>
            ...
            <div className="h-screen flex flex-col overflow-hidden">
                {/* Navbar para vista de autenticación */}
                ...
                <div className="flex-1 flex items-center justify-center p-4 sm:p-6 lg:p-8 relative overflow-hidden">
                    ...
                    <div className="absolute inset-0 bg-gray-50">
                        ...
                        <div className="absolute top-10 -left-20 w-96 h-96 rounded-full bg-purple-200/10 blur-3xl"></div>
                        <div className="absolute bottom-10 -right-20 w-96 h-96 rounded-full bg-pink-200/20 blur-3xl"></div>
                        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] rounded-full border-2 border-purple-200/10"></div>
                        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full border-2 border-purple-300/10"></div>
                    ...
                    <div className="relative w-full max-w-lg mx-auto">
                        <div className="space-y-6">
                            ...
                            {status && (
                                <div
                                    className="flex items-start gap-3 p-3 sm:p-4 rounded-lg border animate-slide-down"
                                    style={{
                            ...
                            <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6 sm:p-8 overflow-hidden">
                                <div
                                                        ...
                                                        {[0, 1, 2, 3].map((index) => (
                                                            ...
                                                            >
                                                                <input
                                                                    ...
                                                                    inputMode="numeric"
                                                                    pattern="[0-9]*"
                                                                    className="w-full text-center text-2xl sm:text-3xl font-black outline-none rounded-2xl border-2 transition-all duration-200"
                                                                    style={{
                                                                        height: "64px",
                                                                        borderColor:
                                                                            pinValues[
            ...
            <style>{`
                ...
                /* Asegurar que no haya scroll innecesario */
                html, body {
                    overflow: hidden;
                    height: 100%;
                }
