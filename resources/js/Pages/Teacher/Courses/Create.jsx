...
import {
    ArrowLeft, BookOpen, GraduationCap, Info, Check, Loader2, 
    AlertCircle, Shield, FileText, Layers, Hash, Clock, Users
} from "lucide-react";
...
export default function Create({ teacher = null }) {
    ...
    return (
        <>
            ...
            <main className={`transition-all duration-300 ease-in-out ${collapsed ? "lg:ml-20" : "lg:ml-72"} min-h-screen relative`}>
                                ...
                                <div className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden animate-slide-up">
                                    ...
                                    <form onSubmit={submit} className="p-8 lg:p-10 space-y-8">
                                        ...
                                        <div className="group/field">
                                            ...
                                            {errors.grade && (
                                                <div className="mt-2 flex items-start gap-2 p-3 bg-red-50 border-l-4 rounded-r-lg animate-slide-down"
                                                    style={{ borderLeftColor: "#EE4266" }}>
                                        ...
                                        <div className="flex items-center justify-end gap-4 pt-8 border-t border-gray-200">
                                            ...
                                            <button
                                                ...
                                                style={{ backgroundColor: "#540D6E", "--tw-ring-color": "rgba(84, 13, 110, 0.5)" }}
                            ...
                            <div className="lg:col-span-1 space-y-6 animate-slide-left">
                                ...
                                <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                                    ...
                                    <div className="space-y-3">
                                        {[
                                            ...
                                            <div key={index} className="flex items-center gap-3 p-3 rounded-lg border transition-all duration-200"
                                                style={{
                                ...
                                <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                                    <div className="flex items-center gap-3 mb-4">
                                        ...
                                        <h3 className="font-bold text-gray-900">Docente a cargo</h3>
                                    </div>
                                    <div className="p-4 bg-gray-50 rounded-lg border border-gray-200">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                <p className="font-medium text-gray-900">{teacher?.name || "Profesor"}</p>
                                ...
                                <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                                    ...
                                    <ul className="space-y-2.5 text-sm text-gray-600">
                                        {[
                                            "Los cursos pueden tener múltiples estudiantes",
                                            "Puede activar/desactivar el curso después de creado",
                                            "La descripción ayuda a identificar el contenido",
                                            "El año lectivo se asignará automáticamente"
                                        ].map((text, i) => (
